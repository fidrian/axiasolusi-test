...
<div class="form-group row">
    <h3 class="col-md-4">Edit User</h3>
</div>
...
<form action="/user/update" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" required value="{{ $u->name }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" required value="{{ $u->email }}" disabled>
